Public Class uc_rentas_reporte_liquidacion
    ...
    Private Sub uc_rentas_reportes_liquidacion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        _DatasetAnnio.Reset()
    ...
    Private Sub btnLiquidacion_Click(sender As Object, e As EventArgs) Handles btnLiquidacion.Click
        Dim rep As New report_rentas_ficha_liquidacion
        ...
        Try
            ...
            cod_annio = cbxperiodo.SelectedValue
            annio = cbxperiodo.Text
            rep.Refresh()
            crvLiquidacion.Refresh()
            rep.SetParameterValue("cod", codigo)
            rep.SetParameterValue("cod_annio", cod_annio)
            rep.SetParameterValue("annio", annio)
            crvLiquidacion.ReportSource = rep

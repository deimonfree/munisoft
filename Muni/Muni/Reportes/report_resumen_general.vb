...
Public Class report_resumen_general
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "report_resumen_general.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Muni.report_resumen_general.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_codContribuyente() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedreport_resumen_general
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As report_resumen_general = New report_resumen_general()
        rpt.Site = Me.Site
        Return rpt
    End Function

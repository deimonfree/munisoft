...
Public Class imprimir_cliente
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Muni.imprimir_cliente.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedimprimir_cliente
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As imprimir_cliente = New imprimir_cliente()
        rpt.Site = Me.Site
        Return rpt
    End Function

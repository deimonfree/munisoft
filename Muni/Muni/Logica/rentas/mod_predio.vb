...
Module mod_predio
    ...
    Sub consulta_datos_predio_autovaluo(ByVal codContribuyente As Integer)
        Try
            conex_Global()
            _conectorMysql.SelectCommand = New MySqlCommand("select predio.idpredio, via.nombre as via, predio.numero, predio.ensiso_numeracion, predio.cuadra, predio.nro_lote from via inner join predio on via.idvia= predio.cod_via where predio.cod_contribuyente = @cod and predio.estado='Activo'", _conexion)
